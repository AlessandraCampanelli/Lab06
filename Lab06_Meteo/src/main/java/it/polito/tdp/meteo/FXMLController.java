...
Model model;
    ...
    void doCalcolaUmidita(ActionEvent event) {
    	txtResult.clear();
  int mese= boxMese.getValue(); // NON METTO CONTROLLI 
  for(Citta loc:this.model.getTuttelocalita()) {
	  txtResult.appendText(loc+"  "+this.model.getUmiditaMedia(mese, loc.getNome())+"\n");
  }
    }
